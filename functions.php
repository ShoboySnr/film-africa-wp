...
function film_africa_wp_scripts() {
    ...
    wp_enqueue_script( 'film-africa-util-js', get_template_directory_uri() . '/scripts/utils/path.js', array('film-africa-jquery', 'film-africa-custom-js'), _S_VERSION, true );
    wp_enqueue_script( 'film-africa-custom-js', get_template_directory_uri() . '/scripts/custom.js', array('film-africa-jquery'), _S_VERSION, true );
    ...
    wp_enqueue_script( 'film-africa-wp-calender', get_template_directory_uri() . '/scripts/calendar.js', array('film-africa-jquery'), _S_VERSION, true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'film_africa_wp_scripts' );
