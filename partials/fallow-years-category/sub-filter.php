...
$sub_categories = PastsFestivals::get_instance()->get_sub_taxonomy($terms->slug, $filter_by, 'whats_on_category', 'fallow_years_category');
$get_filter = $filter_by == 'post' ? 'News' : $filter_by;

if(!empty($sub_categories)) {
?>
<div class="subcategory" id="filters">
    <input
        class="hidden filter"
        type="radio"
