            ...
            <div class="lg:flex pt-20 pb-32 text-lg">
                ...
                <div class="film-details">
                    ...
                    if(!empty($categories)) {
                        ...
                        ?>
                        <span class="press-category inline-block text-black px-3 py-2 text-xs font-bold"><?= $category->name; ?></span>
                        <?php
                        }
                    }
                    ...
                    if(!empty($press_release_format)) {
                        ?>
                        <span class="press-category inline-block text-black px-3 py-2 text-xs font-bold"><?= $press_release_format; ?></span>
                        <?php
                    }
                    ?>
